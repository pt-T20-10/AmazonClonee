    ...
    public partial class Amazon3Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cart>(entity =>
            {
                ...
                entity.Property(e => e.DeliveryOptionId).HasMaxLength(50).HasColumnName("deliveryOptionID");
            ...
            modelBuilder.Entity<CartItem>(entity =>
            {
                ...
                entity.HasOne(d => d.Cart)
                    .WithMany(p => p.CartItems) // Đảm bảo tên Collection là CartItems
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.Product) // Đổi thành d.Product để xác định quan hệ
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.ProductId) // Đổi thành d.ProductId
