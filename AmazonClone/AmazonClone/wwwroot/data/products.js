...
export class Product{
 ...
 export class Clothing extends Product{
  ...
  export class Appliance extends Product{
    ...
    constructor(productDetials){
      super(productDetials);
      this.instructionsLink = productDetials.instructionsLink;
      this.warrantyLink = productDetials.warrantyLink;
    }
    extraInfoHTML(){
      return `
        <a 
          href="${this.instructionsLink}" targer="_blank"> Instructions 
        </a>
        <a 
          href="${this.warrantyLink}" targer="_blank"> WarrantyLink 
        </a> 
      `;
    }
...
export let products = [
  ...
  if (!productDetails.type) {
    productDetails.type = 'Unknown'; // Set a default type if it's missing
  }
